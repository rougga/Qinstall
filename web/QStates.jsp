...
<html>
    ...
    <body class="bg-dark">
        <div class="container pt-4 text-white">
            <h1 class="text-white"><a href="index.jsp" class="btn btn-danger"><< Accueil</a> Creation des tables: (QStates)</h1>
            <div class="w-75 mx-auto mt-4 pt-4">
                ...
                <a href="./InstallTablesQStates" class="btn btn-lg btn-success">Installer toutes les tables</a>
                <%
                }else{
                %>
