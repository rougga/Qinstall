        ...
        <div class="container pt-4 text-white">
            ...
            <div class="w-75 mx-auto mt-4 pt-1">
                <% 
                    ...
                    String[] tables = {"agence","cible","lastupdate","t_biz_type","t_login_log","t_ticket","t_user","t_window","t_window_status","rougga_task","rougga_ticket_task","rougga_zone","rougga_agence_zone","rougga_user","rougga_user_zone"};
                    try{
