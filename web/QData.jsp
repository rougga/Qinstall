...
<html>
    ...
    <body class="bg-dark">
        <div class="container pt-4 text-white">
            ...
            <div class="w-75 mx-auto mt-4 pt-1">
                <% 
            
                    boolean allCreated=true;
                    String[] tables = {"agence","cible","lastupdate","t_biz_type","t_login_log","t_ticket","t_user","t_window","t_window_status","rougga_task","rougga_ticket_task","rougga_zone","rougga_agence_zone","rougga_user","rougga_user_zone","rougga_gbl_table"};
                    try{
                        ...
                        for(int i=0;i < tables.length;i++){
                           ...
                           if (rs.next()) {
                %><%= "<h6 class='text-success'>"+rs.getString(3)+" créé.</h6>" %><%
                           }else{
                            allCreated=false;
                %><%= "<h6 class='text-danger'>"+tables[i]+" indisponible</h6>" %><%
                           }
                        }
                        con.closeConnection();
                    }
                ...
                <a href="./InstallTablesQData" class="btn btn-lg btn-success">Installer toutes les tables</a>
                <%
                }else{
                %>
